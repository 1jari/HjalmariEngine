...
namespace Hjalmari7 {
    namespace Video {
        ...
        void CheckShaderCompilation_f(GLuint shader) {
            GLint success;
        ...
        void CheckProgramLinking_f(GLuint program) {
            GLint success;
        ...
        GLuint CompileShader_f(const char* src, GLenum shaderType) {
            GLuint shader = glCreateShader(shaderType);
            glShaderSource(shader, 1, &src, nullptr);
            glCompileShader(shader);
            CheckShaderCompilation_f(shader);
            return shader;
        }
